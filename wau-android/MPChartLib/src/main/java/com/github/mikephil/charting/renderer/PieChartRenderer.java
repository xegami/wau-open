...
public class PieChartRenderer extends DataRenderer {
    ...
    protected void drawDataSet(Canvas c, IPieDataSet dataSet) {
        ...
        for (int j = 0; j < entryCount; j++) {
            ...
            mRenderPaint.setShader(new RadialGradient(center.x, center.y, radius, dataSet.getGradientColor(e.getColorIndex()).getEndColor(), dataSet.getGradientColor(e.getColorIndex()).getStartColor(), Shader.TileMode.MIRROR));
